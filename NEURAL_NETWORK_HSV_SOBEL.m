...
clear all;
clc;
ruta = 'CENT_HSV_SOBEL\CENTROIDES_';
ext = '.txt';
lista_names = ["APPLE_JUICE","BLUE_BOWL","BLUE_LEGO","BLUE_MUG"...
    "BLUE_SPOON","COOKIES","ORANGE_JUICE","ORANGE_KNIFE"...
    "RED_LEGO","RED_MUG"];
